...
INSERT INTO `category` VALUES (1,'work',0),(2,'school',0),(3,'band',0),(4,'workshop',0);
...
INSERT INTO `task` VALUES (31,'first','firstdescr',1,'2020-10-22 00:00:00','java.awt.Color[r=255,g=102,b=204]',3,NULL,'2020-10-22 15:06:36'),(34,'second','asdfasdf',1,'2020-10-23 00:00:00','java.awt.Color[r=255,g=102,b=102]',2,NULL,'2020-10-22 15:15:18');
...
CREATE TABLE `team` (
  ...
  CONSTRAINT `team_owner_id` FOREIGN KEY (`team_owner_id`) REFERENCES `user` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `team` VALUES (1,'fake users',1),(2,'tudu dev team',1),(3,'sporgy',1),(4,'testie',1);
...
INSERT INTO `user` VALUES (1,'nicholas','123456'),(2,'nicholas2','123456'),(3,'nicholas','123456'),(4,'1','1'),(5,'wednesday','123456');
...
INSERT INTO `user_team` VALUES (19,1,1),(20,1,2),(21,1,3);
...
-- Dump completed on 2020-11-12 16:50:47
